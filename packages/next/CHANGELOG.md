...
- d5e8585: Forward `data-tracking-*` attributes as additional keys on the `websiteClick` event.
    ...
    <html data-tracking-page-type="location-details-page">
        <a href="tel:..." data-event="ga-button" data-tracking-service-type="workshop-service"></a>
    </html>
    ```
